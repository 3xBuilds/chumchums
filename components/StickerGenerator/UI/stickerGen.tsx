...
export const StickerGen:React.FC = () => {
    ...
    const handleDownload = async () => {
        ...
        const canvas = await html2canvas(layeredImageRef.current, {
          width: 1000,
          height: 1000,
          scale: 1, // Adjust this value for higher resolution if needed
          useCORS: true,
          logging: true,
        });
  ...
  return (
    <div className='flex md:flex-row max-md:flex-col h-[95vh] w-screen max-md:overflow-x-hidden md:overflow-y-hidden'>
        ...
        <div className='md:h-full md:w-[67%] h-[67%] w-full items-center flex flex-col mt-5 gap-5 justify-start'>
            ...
            <div ref={layeredImageRef} className='max-md:w-[19rem] relative max-md:h-[19rem] overflow-hidden md:w-[32rem] md:h-[32rem] border-[5px] rounded-xl border-dashed border-white/15'>
