...
export const StickerGen: React.FC = () => {
    ...
    return (
        <div className='w-screen h-screen max-md:overflow-x-hidden overflow-y-hidden object-cover overflow-hidden'>
            ...
            <div className='flex md:flex-row 2xl:-translate-y-36 max-md:flex-col max-sm:h-[30rem] max-md:h-[35rem] items-center gap-2 justify-between overflow-x-hidden md:w-[38rem] max-2xl:translate-x-[-3rem] 2xl:translate-x-[-7rem] pointer-events-auto md:translate-y-[-7rem] translate-y-[3rem]'>
                ...
                <div className='md:h-[55vh] h-[7rem] md:w-[18vw] py-12 max-md:translate-y-4 max-sm:w-[20rem] max-md:w-[30rem] flex flex-col justify-center gap-2 bg-white/10 col-span-2 overflow-y-hidden'>
