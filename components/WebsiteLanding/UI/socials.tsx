...
export const Socials = () => {
  return (
    <div id="socials" className='bg-[#01534D] flex flex-col justify-start items-center'>
        ...
        <div className='max-md:object-cover max-md:overflow-hidden max-sm:w-[30rem] relative max-md:w-[50rem] max-lg:w-[65rem] lg:w-[100rem]'>
          <Image src={bg} alt='bg' className='max-sm:w-[30rem] max-md:w-[50rem] max-lg:w-[65rem] lg:w-[100rem]'/>
